  ...
  en: {
    ...
    homeVisitation: {
      ...
      header: {
        ...
        description: "Record and track home visits conducted by social workers.",
      },
      actions: {
        newVisit: "New Visit",
        edit: "Edit",
  ...
  es: {
    ...
    homeVisitation: {
      ...
      header: {
        ...
        description: "Registrar y hacer seguimiento a las visitas al hogar realizadas por trabajadoras sociales.",
      },
      actions: {
