export const resources = {
  en: {
    ...
    login: {
      title: "Staff Login",
      description: "Access the Hope Shelter admin dashboard",
      emailLabel: "Email",
      emailPlaceholder: "you@hopeshelter.org",
      passwordLabel: "Password",
      passwordPlaceholder: "••••••••",
      submit: "Sign In",
      signingIn: "Signing in…",
      donorTitle: "Donor Login",
      donorDescription: "Access your personalized donation history and impact.",
      registerTitle: "Create an Account",
      registerDescription: "Join Hope Shelter's donor community for free.",
  ...
  es: {
    ...
    login: {
      ...
      donorTitle: "Acceso para donantes",
      donorDescription: "Accede a tu historial de donaciones y tu impacto personalizado.",
      registerTitle: "Crear una cuenta",
      registerDescription: "Únete a la comunidad de donantes de Refugio de Esperanza de forma gratuita.",
